...
<table cellspacing="0" cellpadding="0" class="">
    <tr>
        <td><h1 style="color: #0f0f0f;">TRANSACTION HISTORY</h1></td>
    </tr>
    <tr>
        <td>
...
<table cellspacing="0" cellpadding="0" class="tablemain" style="margin-top: 50px;">
    ...
    <tr>
        <td class="border-top border-right width70"></td>
        <td class="border-top width30"><?php echo e('N'.number_format($transactions->sum('amount_paid'), 2)); ?></td>
    </tr>
    </tbody>
</table>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\fnbi\resources\views/user/transaction/exportPDF.blade.php ENDPATH**/ ?>