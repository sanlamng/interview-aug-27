    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a class="has-arrow ai-icon" href="{{ route('logout') }}" onclick="event.preventDefault();
            ...
            <div class="row">
                <div class="col-xl-12" style="margin-bottom: 3rem;">
                    <div class="welcome-card rounded pl-5 pt-5 pb-4 mt-3 position-relative mb-5 welcome-speech">
                        <h4 class="text-warning">Welcome to First Bank Insuranace</h4>
                        <p>This dashboard shows all your payment transactions. <br> Ensure you check here always to view your transactions.</p>
                ...
                <div class="col-xl-12" style="margin-bottom:2rem ;">
                    ...
                    <div class="card text-white bg-primary">
                        <div class="card-header " style="border-bottom: 1px solid rgb(211 191 191 / 90%);">
                            <h5 class="card-title text-white ">Product: <span class="testapi-header">{{$transaction->product}} </span></h5>
                        </div>

                        <div class="card-body mb-0 " style="border-bottom: 1px solid rgb(211 191 191 / 90%);">
                            <h5 class="card-title text-white ">Amount Paid: <span class="testapi-header">&#8358; {{$transaction->amount_paid}}</span></h5>

                        </div>

                        <div class="card-footer bg-transparent border-0 text-white"><span class="testAPI-date" style="font-weight:700 ;"> {{$transaction->created_at}} </span>
                            <h5 class="card-title text-white ">Payment Date: <span class="testapi-header">{{$transaction->date_of_Payment}}</span></h5>
                        </div>
                    </div>
                </div>
                @endforeach
